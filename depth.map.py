...
class DepthMap:
    def __init__(self, showImages):
        root = os.getcwd()
        imgLeftPath = os.path.join(root, 'demoImages//cubo//WIN_20241115_13_44_18_Pro.jpg')
        imgRightPath = os.path.join(root, 'demoImages//cubo//WIN_20241115_13_44_25_Pro.jpg')
